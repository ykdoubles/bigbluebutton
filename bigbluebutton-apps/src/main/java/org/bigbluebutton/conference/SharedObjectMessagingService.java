...
public class SharedObjectMessagingService {
	private ConcurrentHashMap<String, ISharedObject> whiteboardSharedObjects;
	private ConcurrentHashMap<String, ISharedObject> presentationSharedObjects;
	
	private ConcurrentHashMap<String, IScope> scopes;
	
	public SharedObjectMessagingService() {
		whiteboardSharedObjects = new ConcurrentHashMap<String, ISharedObject>();
		presentationSharedObjects = new ConcurrentHashMap<String, ISharedObject>();
	}
	
	public void addConnection(String id, IScope conn) {
		if (connections == null) {
